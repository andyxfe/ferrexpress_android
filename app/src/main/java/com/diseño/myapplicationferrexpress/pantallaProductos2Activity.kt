...
class pantallaProductos2Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_producto_pantalla2)
        ...
        asignarCambioImagen(miniatura1,imagenPrincipal,R.drawable.maletin)
        asignarCambioImagen(miniatura2,imagenPrincipal,R.drawable.maletin1)
        asignarCambioImagen(miniatura3,imagenPrincipal,R.drawable.maletin2)
        asignarCambioImagen(miniatura4,imagenPrincipal,R.drawable.maletin3)
